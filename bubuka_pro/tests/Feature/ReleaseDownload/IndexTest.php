...
class IndexTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        ReleaseDownload::factory($this->max)->create();
    }
     ...
     * @test
     */
    public function response_for_route_releases_downloads_index()
    {
        ...
        $this->assertCount($this->max, $response['body']['releases_downloads']);
    }
     ...
     * @test
     */
    public function response_for_route_releases_downloads_index_with_limit()
    {
        // Отключаем обработку исключении
        $this->withoutExceptionHandling();
        ...
        $this->assertCount($limit, $response['body']['releases_downloads']);
    }
     ...
     * @test
     */
    public function response_for_route_releases_downloads_index_with_limit_and_offset()
    {
        ...
        $response = $this->withHeaders([
            'Authorization' => 'Bearer '.$this->userToken,
        ])->get('api/rels_dls/?limit='.$limit.'&'.'offset='.$offset);
        ...
        $this->assertCount($difference, $response['body']['releases_downloads']);
    }
     ...
     * @test
     */
    public function response_for_route_releases_downloads_index_with_offset_and_withOut_limit()
    {
        $offset = 2;
        ...
        $response = $this->withHeaders([
            'Authorization' => 'Bearer '.$this->userToken,
        ])->get('api/rels_dls/?offset='.$offset);
    ...
    public function user_is_user()
    {
        ...
        $response = $this->get('api/rels_dls');
