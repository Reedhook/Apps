...
/** Тестирования метода index, контроллера IndexController of ChangeLog */
...
class IndexTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        ChangeLog::factory($this->max)->create();
    }
     ...
     * @test
     */
    public function response_for_route_changes_index()
    {
        ...
        $this->assertCount($this->max, $response['body']['changelogs']);
    }
     ...
     * @test
     */
    public function response_for_route_changes_index_with_limit()
    {
        // Отключаем обработку исключении
        $this->withoutExceptionHandling();
        ...
        // Сравнение limit с количеством вернувшихся записей
        $this->assertCount($limit, $response['body']['changelogs']);
    }
     ...
     * @test
     */
    public function response_for_route_changes_index_with_limit_and_offset()
    {
        ...
        $response = $this->withHeaders([
            'Authorization' => 'Bearer '.$this->userToken,
        ])->get('api/changes/?limit='.$limit.'&'.'offset='.$offset);
        ...
        $this->assertCount($difference, $response['body']['changelogs']);
    }
     ...
     * @test
     */
    public function response_for_route_changes_index_with_offset_and_withOut_limit()
    {
        $offset = 2;
    ...
    public function validation_limit_to_integer()
    {
        ...
        // Запрос на endpoint с передачей значений limit и offset в качестве параметров
        $response = $this->withHeaders([
            'Authorization' => 'Bearer '.$this->userToken,
        ])->get("api/changes/?limit=$limit&offset=$offset");
